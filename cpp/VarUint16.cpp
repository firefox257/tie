...
#ifndef VARUINT16_CPP
#define VARUINT16_CPP

#include "VarUint16.hpp"

#define BASE VarUint16
#define BASEDATA uint16_t


void BASE::ThrowNotImplemented(string file, int line)
{
	throw Exception("var uint16 Not implmented.", file, line);
}
void BASE::ThrowException(string file, int line, string msg)
{
	throw Exception("var uint16 " + msg, file, line);
}

//public:
VarType::Types BASE::Type()
{
	static const VarType::Types t = VarType::Uint16;
	return t;
}
