...
#define BASE VarInt8
#define BASEDATA int8_t


void BASE::ThrowNotImplemented(string file, int line)
{
	throw Exception("var int8 Not implmented.", file, line);
}
void BASE::ThrowException(string file, int line, string msg)
{
	throw Exception("var int8 " + msg, file, line);
}

//public:
VarType::Types BASE::Type()
{
	static const VarType::Types t = VarType::Int8;
	return t;
}
