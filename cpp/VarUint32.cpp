#ifndef VARUINT32_CPP
#define VARUINT32_CPP

#include "VarUint32.hpp"

#define BASE VarUint32
#define BASEDATA uint32_t


void BASE::ThrowNotImplemented(string file, int line)
{
	throw Exception("var uint32 Not implmented.", file, line);
}
void BASE::ThrowException(string file, int line, string msg)
{
	throw Exception("var uint32 " + msg, file, line);
}

//public:
VarType::Types BASE::Type()
{
	static const VarType::Types t = VarType::Uint32;
	return t;
}
