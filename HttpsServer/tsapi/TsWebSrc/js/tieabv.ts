...
(function()
{
	...
	//export
	function $attr(dom:any, a:any, s:any)
	{
		if(s)
		{
	...
	//export
	function $hasAttr(dom:any, a:any)
	{
		return dom.hasAttribute(a);
	}

	//export
	function $removeattr(dom:any, a:any)
	{
	...
	var $msgc:any = {
		_funcs: {},
		subscribe: function(name:any, func:any)
		{
			if(!this._funcs[name]) this._funcs[name] = []
			this._funcs[name].push(func);
		},
		send: function(name:any, ...args:any)
		{
			if(this._funcs[name])
			{
		...
		unsubscribe: function(name:any, func:any)
		{
	...
	//export
	function $syncfetchtext(url:string)
	{
	...
	//export
	function $fastpath(obj:any, p:any, v:any)
	{
		if(!p)
		{
			console.log("no path");
		...
		if(v===undefined)
		{
			return p.split(".").reduce((o:any, pp:any)=>
			{
				if(!o) return o;
				return o[pp];
			}, obj);
...
(function()
{
	function $boxeval(____code:string)
	{
		try
		{
			eval(____code);
...
(function()
{
		var __comps:{[key:string|number]: any} = {};


		//export
		function $comp(name:any, o:any)
		{
			if(o)
			{
				if(o.css)
...
(function()
{
	function createGetSet(o:any, path1:any, getfunc:any, setfunc:any)
	{
		var att = path1.split(".");
		if(att.length <=1)
		{
	...
	function createGet(o:any, path1:any, getfunc:any)
	{
		var att = path1.split(".");
		if(att.length <=1)
		{
	...
	function getDomTie(dom:any)
	{
		...
		{
			a[i] = a[i].split(":").map((a:any)=> a.trim());
		}
		return a;
	}
	//tieevents="objectname:domOrParentObj"
	function getDomTieEvents(dom:any)
	{
	...
	function getDomTieRead(dom:any)
	{
	...
	//tieclass="objectname"
	function getDomTieClass(dom:any)
	{
	...
	function getDomTieRadio(dom:any)
	{
	...
	function getDomTieAttributes(dom:any)
	{
		var attri = $.attr(dom, "ta");//tieattributes attributes
		if(!attri) return undefined;
		var a:any[] = attri.split(",");
	...
	function getDomTrackEvents(dom:any)
	{
		var attri = $.attr(dom, "te");//tieevnets attribute
		if(!attri) return undefined;
		var a = attri.split(",").map((a:any)=>a.trim());
		return a;
	}

	function setCompDomAttributes(scaf:any, dom:any, objscaf:any)
	{
	...
	function addCompAttributesSetTracker(po:any, o:any, path1:any, path2:any)
	{
		$.fastpath(po.tracker, path1).push(function(v:any)
		{
			//potential @obj
	...
	function addCompTieSetTracker(po:any, o:any, path1:any, path2:any)
	{
		$.fastpath(po.tracker, path1).push(function(v:any)
		{
			//potential @obj
	...
	function createCompAttributesGetSet(o:any, path1:any)
	{
	...
	function setCompAttributesBackerTracker(objscaf:any, parentobjscaf:any)
	{
	...
	function setCompTieBackerTracker(objscaf:any, parentobjscaf:any)
	{
		var tie = objscaf.tie;
		var o = objscaf.obj;
		var po = parentobjscaf.obj;
	...
	function setCompTieReadBackerTracker(objscaf:any, parentobjscaf:any)
	{
	...
	function setCompToParentCompTies(objscaf:any, parentobjscaf:any)
	{
	...
	function remakeDom(objscaf:any)
	{
	...
	function addDomSetTracker(o:any, dom:any, path1:any, path2:any)
	{
		$.fastpath(o.tracker, path1).push(function(v:any)
		{
			//potential @obj
	...
	function createTieGetSet(o:any, path1:any)
	{
	...
	function setTieBackerTrackerFields(scaf:any, objscaf:any, domscaf:any)
	{
		var tie = domscaf.tie;
		if(!tie) return;
		var o = objscaf.obj;
	...
	function createDomTieEvent(o:any, dom:any, path1:any, path2:any)
	{
		$.fastpath(dom, path2, $.fastpath(o, path1));
	}

	function setTieEvents(scaf:any, objscaf:any, domscaf:any)
	{
	...
	function createTieReadGet(o:any, dom:any, path1:any, path2:any)
	{
		createGet(o, path1,
		function()
		{
	...
	function createCompTieReadGet(po:any, o:any, path1:any, path2:any)
	{
		createGet(po, path1,
		function()
		{
	...
	function setTieRead(scaf:any, objscaf:any, domscaf:any)
	{
	...
	function addDomSetClassTracker(o:any, dom:any, path:any)
	{
		$.fastpath(o.tracker, path).push(function(v:any)
		{
			//potential @obj
	...
	function createTieClassGetSet(o:any, path1:any)
	{
		createGetSet(o, path1,
		function()
		{
	...
	function setTieClass(scaf:any, objscaf:any, domscaf:any)
	{
	...
	function setTieDom(scaf:any, objscaf:any, domscaf:any)
	{
	...
	function addDomSetAttributesTracker(o:any, dom:any, path1:any, path2:any)
	{
		$.fastpath(o.tracker, path1).push(function(v:any)
		{
	...
	function createTieAttributesGetSet(o:any, path1:any)
	{
	...
	function setTieAttributes(scaf:any, objscaf:any, domscaf:any)
	{
	...
	function createTrackEvent(o:any, dom:any, path:any)
	{
		$.fastpath(dom, path, function(e:any)
		{
	...
	function setTrackEvents(scaf:any, objscaf:any, domscaf:any)
	{
	...
	function parseDom(scaf:any, objscaf:any, dom:any)
	{
		var domscaf:{[key:number|string]:any} = {};
		domscaf.dom = dom;
	...
	function removedDom(records:any)
	{
		for(var a = 0; a < records.length; a++)
		{
			...
			for(var b = 0; b < nodes.length; b++)
			{
				...
				$.qa("*[tt], *[t], *[tr], *[tc], *[te], *[tke], *[td], *[tradio], *[ta], *[to]",nodes[b]).forEach((dom1:any)=>
				{
	...
	function parseTempDom(scaf:any, objscaf:any)
	{
		...
		//$.qa("*[tietype], *[tie], *[tieread], *[tieclass], *[tieevents], *[trackevents], *[tiedom], *[tieradio], *[tieattributes], *[tieobj]", objscaf.tempdom).forEach((tdom)=>
		$.qa("*[tt], *[t], *[tr], *[tc], *[te], *[tke], *[td], *[tradio], *[ta], *[to]", objscaf.tempdom).forEach((tdom:any)=>
		{
	...
	function parseComp(scaf:any, dom:any, parentobjscaf:any)
	{
		...
		var objscaf:{[key:number|string]: any} = {};
		objscaf.dom = dom;
		...
		$.qa("*[tg]", objscaf.tempdom).forEach((tdom:any)=>//tieglobal attribute
		{
		...
		$.qa("*[tgt]", objscaf.tempdom).forEach((tdom:any)=>//tieglobal attribute
		{
	...
	//export
	function $doc(pobj:any)
	{
		var scaf:{[key:number|string]:any} = {};
		scaf.listOfObjs = [];
		var comps:any[] = [];
		$.qa("c").forEach((doc:any)=>//doc attribute
		{
			//parseComp(scaf, doc);
			comps.push(doc);
		});
		var parentobj: {[key:number|string]: any} = {
			obj: pobj
		};
		for(var i = 0; i < comps.length; i++)
		{
	...
	//export
	function $append(o:any, dom:any, compstr:any)
	{
		var scaf:{[key:number|string]: any} = {};
		scaf.listOfObjs = [];
