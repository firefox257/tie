...
{
    var maps:{[key:string]: any} = {};


    var atthis:any = function (class2:any, val:any)
    {
        var n2 = class2.name;
    ...
    atthis.Set  = function (class1:any, class2:any, tiefunc:any): any
    {
        var n1 = class1.name;
        var n2 = class2.name;
        ...
        var defs: [{[key:string]: any}, {[key:string]: any}] =[{}, {}];
        for(var i in o1)
        {
