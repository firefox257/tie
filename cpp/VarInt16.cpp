...
#define BASE VarInt16
#define BASEDATA int16_t


void BASE::ThrowNotImplemented(string file, int line)
{
	throw Exception("var int16 Not implmented.", file, line);
}
void BASE::ThrowException(string file, int line, string msg)
{
	throw Exception("var int16 " + msg, file, line);
}

//public:
VarType::Types BASE::Type()
{
	static const VarType::Types t = VarType::Int16;
	return t;
}
