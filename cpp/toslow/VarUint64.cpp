...
#ifndef VARUINT64_CPP
#define VARUINT64_CPP

#include "VarUint64.hpp"

#define BASE VarUint64
#define BASEDATA uint64_t
...
{
	static const VarType::Types t = VarType::Uint64;
	return t;
}
