...
#define BASE VarInt32
#define BASEDATA int32_t


void BASE::ThrowNotImplemented(string file, int line)
{
	throw Exception("var int32 Not implmented.", file, line);
}
void BASE::ThrowException(string file, int line, string msg)
{
	throw Exception("var int32 " + msg, file, line);
}

//public:
VarType::Types BASE::Type()
{
	static const VarType::Types t = VarType::Int32;
	return t;
}
